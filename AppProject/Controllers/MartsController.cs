...
namespace AppProject.Controllers
{
    public class MartsController : Controller
    {
        ...
        {
            return View(await _context.Mart.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("MartId")] Mart mart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MartId")] Mart mart)
        {
            if (id != mart.MartId)
            {
                return NotFound();
